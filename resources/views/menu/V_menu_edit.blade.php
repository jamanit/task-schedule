        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="firstmenu_editModalLabel{{ $firstmenu->id_firstmenu }}">Edit First Menu</h4>
                ...
                <form action="{{ route('menu_firstmenu_update', $firstmenu->id_firstmenu) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="firstmenu_name" id="firstmenu_name" value="{{ $firstmenu->firstmenu_name }}" class="form-control firstmenu_name @error('firstmenu_name') is-invalid @enderror" placeholder="Firstmenu Name" autofocus>
...
@if (isset($secondmenu))
    <div class="modal fade text-left" id="secondmenu_editModal{{ $secondmenu->id_secondmenu }}" tabindex="-1" role="dialog" aria-labelledby="secondmenu_editModalLabel{{ $secondmenu->id_secondmenu }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="secondmenu_editModalLabel{{ $secondmenu->id_secondmenu }}">Edit Second Menu</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('menu_secondmenu_update', $secondmenu->id_secondmenu) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="secondmenu_name" id="secondmenu_name" value="{{ $secondmenu->secondmenu_name }}" class="form-control secondmenu_name @error('secondmenu_name') is-invalid @enderror" placeholder="Secondmenu Name">
...
@if (isset($thirdmenu))
    <div class="modal fade text-left" id="thirdmenu_editModal{{ $thirdmenu->id_thirdmenu }}" tabindex="-1" role="dialog" aria-labelledby="thirdmenu_editModalLabel{{ $thirdmenu->id_thirdmenu }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="thirdmenu_editModalLabel{{ $thirdmenu->id_thirdmenu }}">Edit Third Menu</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('menu_thirdmenu_update', $thirdmenu->id_thirdmenu) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="thirdmenu_name" id="thirdmenu_name" value="{{ $thirdmenu->thirdmenu_name }}" class="form-control thirdmenu_name @error('thirdmenu_name') is-invalid @enderror" placeholder="Thirdmenu Name">
...
@if (isset($fourthmenu))
    <div class="modal fade text-left" id="fourthmenu_editModal{{ $fourthmenu->id_fourthmenu }}" tabindex="-1" role="dialog" aria-labelledby="fourthmenu_editModalLabel{{ $fourthmenu->id_fourthmenu }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="fourthmenu_editModalLabel{{ $fourthmenu->id_fourthmenu }}">Edit Fourth Menu</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('menu_fourthmenu_update', $fourthmenu->id_fourthmenu) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fourthmenu_name" id="fourthmenu_name" value="{{ $fourthmenu->fourthmenu_name }}" class="form-control fourthmenu_name @error('fourthmenu_name') is-invalid @enderror" placeholder="Fourthmenu Name">
