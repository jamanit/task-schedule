<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu bg-primary navbar-dark navbar-fixed navbar-shadow navbar-brand-center">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ Auth::user()->name }}</span>
                                <span class="user-status">{{ Auth::user()->level->level_name }}</span>
                            </div><span><img class="round" src="{{ asset('/') }}vuexy-template/app-assets/images/portrait/small/user_view_red.png" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="page-user-profile.html"><i class="feather icon-user"></i> Profile</a><a class="dropdown-item" href="app-email.html"><i class="feather icon-mail"></i> Inbox</a>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ asset('/') }}vuexy-template/app-assets/images/icons/xls.png" alt="png" height="32"></div>
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ asset('/') }}vuexy-template/app-assets/images/icons/jpg.png" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ asset('/') }}vuexy-template/app-assets/images/icons/pdf.png" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ asset('/') }}vuexy-template/app-assets/images/icons/doc.png" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="{{ asset('/') }}vuexy-template/app-assets/images/portrait/small/user.jpeg" alt="png" height="32"></div>
                <div class="search-data">
